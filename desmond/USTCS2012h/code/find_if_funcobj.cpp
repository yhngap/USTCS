...
// A predicate, i.e. a boolean function, to specify the criteria for the searching
...
int main() {
  ...
  // specified using the predicate, i.e. the first prime number
  // Parameters needed:
  // - v.begin() 
  ...
  Prime primeObj;
  vector<int>::iterator it = find_if(v.begin(), v.end(), primeObj);
